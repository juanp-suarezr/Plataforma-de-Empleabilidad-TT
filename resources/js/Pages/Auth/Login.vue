<template>
    ...
    <GuestLayout :isRegister=false>
        ...
        <form @submit.prevent="submit">
            <div>
                <InputLabel class="text-white" for="email" value="Correo electronico" />
            ...
            <div class="mt-3">
                <InputLabel class="text-white" for="password" value="Contraseña" />
            ...
            <div class="mt-4 flex justify-between">
                <label class="inline-flex items-center">
                    ...
                    <span class="mx-2 text-sm text-gray-400">Recordarme</span>
                </label>

                <Link v-if="canResetPassword" :href="route('password.request')"
                    class="text-sm text-gray-400 underline hover:text-gray-900">
